...
using DhubSolutions.PerformanceParticipation.Infrastructure.Data.Configurations.Reports;
using Microsoft.AspNetCore.Identity.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore;

namespace DhubSolutions.PerformanceParticipation.Infrastructure.Data.Context
{
    public class PerformanceParticipationDbContext : IdentityDbContext<User>
    {

        public PerformanceParticipationDbContext(DbContextOptions<PerformanceParticipationDbContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            void ApplyConfigurations()
            {
                ...
                modelBuilder
                    ...
                    .ApplyConfiguration(new ReportElementConfig())
                    .ApplyConfiguration(new ReportTemplateConfig())
                    .ApplyConfiguration(new ReportTemplateElementConfig());
            }
        }
    }
}
