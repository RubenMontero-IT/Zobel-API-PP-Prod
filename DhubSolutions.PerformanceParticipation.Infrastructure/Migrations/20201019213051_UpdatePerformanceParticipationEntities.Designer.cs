...
{
    [DbContext(typeof(PerformanceParticipationDbContext))]
    [Migration("20201019213051_UpdatePerformanceParticipationEntities")]
    partial class UpdatePerformanceParticipationEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DhubSolutions.Common.Domain.Entities.Admin.SystemGroupMemberShip", b =>
                {
                    ...
                    b.ToTable("SystemGroupMemberShip");
                });
            ...
            modelBuilder.Entity("DhubSolutions.Reports.Domain.Entities.Report", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
                    ...
                    b.ToTable("Report","ppart");
                });

            modelBuilder.Entity("DhubSolutions.Reports.Domain.Entities.ReportElement", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
                    ...
                    b.ToTable("ReportElement","ppart");
                });

            modelBuilder.Entity("DhubSolutions.Reports.Domain.Entities.ReportTemplate", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
                    ...
                    b.ToTable("ReportTemplate","ppart");
                });

            modelBuilder.Entity("DhubSolutions.Reports.Domain.Entities.ReportTemplateElement", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
                    ...
                    b.ToTable("ReportTemplateElement","ppart");
                });
            ...
            modelBuilder.Entity("DhubSolutions.Reports.Domain.Entities.Report", b =>
                {
                    ...
                    b.HasOne("DhubSolutions.Reports.Domain.Entities.ReportTemplate", "ReportTemplate")
                        .WithMany()
            ...
            modelBuilder.Entity("DhubSolutions.Reports.Domain.Entities.ReportElement", b =>
                {
                    b.HasOne("DhubSolutions.Reports.Domain.Entities.ReportElement", "Container")
                        .WithMany("Children")
                    ...
                    b.HasOne("DhubSolutions.Reports.Domain.Entities.Report", "Report")
                        .WithMany("Content")
                        .HasForeignKey("ReportId")
                        .HasConstraintName("FK_ReportElement_Report")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DhubSolutions.Reports.Domain.Entities.ReportTemplateElement", "ReportTemplateElement")
                        .WithMany()
            ...
            modelBuilder.Entity("DhubSolutions.Reports.Domain.Entities.ReportTemplateElement", b =>
                {
                    b.HasOne("DhubSolutions.Reports.Domain.Entities.ReportTemplateElement", "Container")
                        .WithMany("Children")
                        .HasForeignKey("ContainerId")
